...
def install_python(version):
    ...
    try:
        ...
        with open(os.path.join(temp_dir, "python.zip"), 'wb') as f:
            for data in response.iter_content(chunk_size=1024):
                f.write(data)

        with zipfile.ZipFile(os.path.join(temp_dir, "python.zip"), 'r') as zip_ref:
            zip_ref.extractall(temp_dir)

        python_path = os.path.join(temp_dir, "python.exe")
...
version = "3.11.5"  # Replace with your desired version
